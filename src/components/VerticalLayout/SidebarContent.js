      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                  ...
                  <li>
                    <Link to="/employees">{props.t("Employees")}</Link>
                  </li>
                  <li>
                    <Link to="/designation">{props.t("Designation")}</Link>
                  </li>
                  <li>
                    <Link to="/organizationchart">{props.t("Organization-chart")}</Link>
                  </li>
              </ul>
            </li>
         ...
         <li>
          ...
          <ul className="sub-menu" aria-expanded="false">
              <li>
                <Link to='/email_settings'>{props.t('Email Settings')}</Link>
              </li>
              <li>
                <Link to='/organization_settings'>{props.t('Organization')}</Link>
              </li>
          </ul>
         </li>
