              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item">
                  <Link className="nav-link" to="/request">
                    <i className="ti-new-window me-2" />
                    {props.t("Request")} {props.menuOpen}
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link" to="/processes">
                    <i className="ti-arrow-right me-2" />
                    {props.t("Processes")} {props.menuOpen}
                  </Link>
                </li>
